...
from gensim.utils import tokenize # 'if you are using a different tokenizer you may need to import it here.
import re
...
parser.add_argument("--hyper", nargs='*',default=['epochs=40','window=20'],
...
# If you are using a different tokenizer (e.g. one which requires instantiating a tokenizer object),
# you may need to set it up here.
